...
The same section includes a one-shot **Click-block self-test**. Arming it makes Minecraft ignore the next server-menu
slot click before the screen handles it, reports success in chat, and then disarms. It expires after 60 seconds if
unused.
